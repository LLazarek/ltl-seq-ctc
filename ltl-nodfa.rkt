...
(module+ test
  (define next-is-all-a-c (c/next (c/all (curry equal? 'a))))

  (check-true (check-consumer next-is-all-a-c '(a a)))
  (check-true (check-consumer next-is-all-a-c '("test" a)))
  (check-true (check-consumer next-is-all-a-c '(a a a)))
  (check-true (check-consumer next-is-all-a-c '(a a a a a a)))
  (check-true (check-consumer next-is-all-a-c '(#f a a a a a a)))
  (check-true (check-consumer next-is-all-a-c '(b a a a a a a)))
  (check-false (check-consumer next-is-all-a-c '(a b c)))
  (check-false (check-consumer next-is-all-a-c '(a a c)))
  (check-false (check-consumer next-is-all-a-c '(a)))
  (check-false (check-consumer next-is-all-a-c '(a a a a a b)))
  (check-false (check-consumer next-is-all-a-c '(a a a a a b a)))
  (check-false (check-consumer next-is-all-a-c '(a b a a a a a)))

  (define next-starts-with-number-c (c/next (primitive/first number?)))
  (check-true (check-consumer next-starts-with-number-c '(1 2)))
  (check-true (check-consumer next-starts-with-number-c '(1 2 3)))
  (check-true (check-consumer next-starts-with-number-c '("nan" 2 3)))
  (check-true (check-consumer next-starts-with-number-c '("nan" 2 a)))
  (check-true (check-consumer next-starts-with-number-c '("nan" 2 a "b" 3)))
  (check-false (check-consumer next-starts-with-number-c '(1 a)))
  (check-false (check-consumer next-starts-with-number-c '(a a)))
  (check-false (check-consumer next-starts-with-number-c '()))
  (check-false (check-consumer next-starts-with-number-c '(= "2" 3))))
